...
const cartController = {
  ...
  async addToCart(req, res) {
    try {
      console.log(req.body, "CART-REQ.BODY-55");
      ...
      if (!res.headersSent) {
        return res
          .status(500)
          .send({ msg: "Error from Cart Controller ", flag: 0 });
      }
    }
  },
...
//           return res
//             .status(400)
//             .json({ msg: "User ID and Product ID are required", flag: 0 });
//         }
...
//         res
//           .status(500)
//           .json({ msg: "Server error", flag: 0, error: error.message });
//       }
//     },
// };
