      ...
      >
        <div className="flex items-center space-x-3">
          <Link to={"/"} className="flex items-center space-x-3">
            <div className="w-10 h-10 bg-teal-600 rounded-full shadow-md">
              <img src="/img/mike2.png" alt="" />
            </div>
          ...
          <div className="flex text-right space-x-1">
            {user == null ? (
              <Link to={"/login?ref=Products"}>
                <div className="font-semibold cursor-pointer text-black hover:text-teal-600 transition">
                  LOG IN |
                </div>
              </Link>
            ) : (
