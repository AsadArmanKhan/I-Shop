        ...
        <div className="flex">
          ...
          <div className="flex-1 ml-6 rounded-2xl overflow-hidden relative">
            <div
              ...
              style={{
                backgroundImage:  "url('.frontend/public/img/Tabpanel.png')", // Update with actual path if needed
              }}
            >
              {/* <img src="/images/keyboar.png" alt="Keyboard" className="w-16 h-16 rounded-full" /> */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
          ...
          <div className="border rounded-lg p-4 bg-white">
            ...
            <div className="grid grid-cols-4 gap-4 items-center">
              <img src="/img/brands/jamk.png" alt="Jamk" className="h-6 object-contain" />
              <img src="/img/brands/digitek.png" alt="Digitek" className="h-6 object-contain" />
              <img src="/img/brands/tekreactjs.png" alt="Tek React" className="h-6 object-contain" />
              <img src="/img/brands/grafbase.png" alt="Grafbase" className="h-6 object-contain" />
              <img src="/img/brands/ohbear.png" alt="Ohbear" className="h-6 object-contain" />
              <img src="/img/brands/oak.png" alt="Oak" className="h-6 object-contain" />
              <img src="/img/brands/snyk.png" alt="Snyk" className="h-6 object-contain" />
              <img src="/img/brands/sonex.png" alt="Sonex" className="h-6 object-contain" />
              <img src="/img/brands/stropi.png" alt="Stropi" className="h-6 object-contain" />
              <img src="/img/brands/msi.png" alt="MSI" className="h-6 object-contain" />
            </div>
          </div>
          ...
          <div className="border rounded-lg p-4 bg-white">
            ...
            <div className="flex justify-between items-center gap-4">
              <div className="flex flex-col items-center">
                <img src="/img/categories/laptop.png" alt="Laptops" className="h-16 object-contain" />
                <span className="mt-2 font-medium">Laptops</span>
              </div>
              <div className="flex flex-col items-center">
                <img src="/img/categories/pc.png" alt="PC Gaming" className="h-16 object-contain" />
                <span className="mt-2 font-medium">PC Gaming</span>
              </div>
              <div className="flex flex-col items-center">
                <img src="/img/categories/headphones.png" alt="Headphones" className="h-16 object-contain" />
                <span className="mt-2 font-medium">Headphones</span>
              </div>
              <div className="flex flex-col items-center">
                <img src="/img/categories/monitor.png" alt="Monitors" className="h-16 object-contain" />
      ...
      <div className="mt-10 bg-white rounded-2xl shadow-lg overflow-hidden">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="flex-1 p-6">
            <h2 className="text-teal-600 font-semibold mb-2">DEALS OF THE DAY</h2>

            <div className="flex flex-col md:flex-row items-center">
              {/* Product Images */}
              <div className="flex md:flex-col items-center gap-2 mr-6">
                <img src="/img/products/phone_main.png" alt="Main Phone" className="w-24 h-auto rounded-lg" />
                <div className="flex md:flex-col gap-2">
                  <img src="/img/products/phone_thumb1.png" alt="Thumb 1" className="w-10 h-16 object-contain" />
                  <img src="/img/products/phone_thumb2.png" alt="Thumb 2" className="w-10 h-16 object-contain" />
                  <img src="/img/products/phone_thumb3.png" alt="Thumb 3" className="w-10 h-16 object-contain" />
                </div>
              </div>
          ...
          <div className="w-full md:w-64 bg-gray-100 p-4 flex flex-col gap-4">
            <img src="/img/ads/gamepads.png" alt="Gamepad Sale" className="rounded-lg object-cover h-32 w-full" />
            <img src="/img/ads/magazine.png" alt="Magazine" className="rounded-lg object-cover h-32 w-full" />
            <img src="/img/ads/phone-angled.png" alt="Phone Angle" className="rounded-lg object-cover h-32 w-full" />
          </div>
        </div>
